...
<div v-click="3" class="w-full bg-slate-800 text-white p-4 rounded-xl shadow-md text-xs flex justify-around items-center mt-2">
  <div><b class="text-blue-400">Trabajos Teóricos:</b> Exclusivamente en formato <b>PDF</b></div>
  <div class="h-4 w-px bg-slate-600"></div>
  <div><b class="text-emerald-400">Prácticas Código:</b> Entrega mediante <b>GitHub Classroom</b></div>
</div>
...
<span class="text-xs text-blue-500 font-mono uppercase tracking-wider font-bold">Algoritmos frente a Estructuras de Datos</span>

<!-- Definición General -->
<div v-click="1" class="my-2 p-2.5 rounded-xl bg-blue-500/10 border-l-4 border-blue-500 text-xs leading-relaxed">
...
<div v-click="2" class="grid grid-cols-2 gap-2 my-2">
  ...
  <div class="border border-gray-200 dark:border-gray-700/80 bg-gray-50/50 dark:bg-gray-800/40 p-2.5 rounded-xl shadow-xs">
    <div class="font-bold text-xs text-blue-600 dark:text-blue-400 mb-0.5">🎯 Precisión</div>
    <p class="text-[11px] opacity-80 leading-tight">Indica rigurosamente el orden secuencial de realización de cada paso, sin ambigüedades.</p>
  </div>

  <div class="border border-gray-200 dark:border-gray-700/80 bg-gray-50/50 dark:bg-gray-800/40 p-2.5 rounded-xl shadow-xs">
    <div class="font-bold text-xs text-emerald-600 dark:text-emerald-400 mb-0.5">🔄 Definición</div>
    <p class="text-[11px] opacity-80 leading-tight">Al ejecutarse con los mismos datos de entrada, siempre debe generar exactamente el mismo resultado.</p>
  </div>

  <div class="border border-gray-200 dark:border-gray-700/80 bg-gray-50/50 dark:bg-gray-800/40 p-2.5 rounded-xl shadow-xs">
    <div class="font-bold text-xs text-amber-600 dark:text-amber-400 mb-0.5">⏳ Finitud</div>
    <p class="text-[11px] opacity-80 leading-tight">Debe finalizar en algún momento; consta de un número determinado y finito de pasos.</p>
  </div>

  <div class="border border-gray-200 dark:border-gray-700/80 bg-gray-50/50 dark:bg-gray-800/40 p-2.5 rounded-xl shadow-xs">
    <div class="font-bold text-xs text-purple-600 dark:text-purple-400 mb-0.5">🧩 Partes Claras</div>
    <p class="text-[11px] opacity-80 leading-tight">Estructura explícita dividida en: <b>Entrada</b> ➔ <b>Proceso</b> ➔ <b>Salida</b>.</p>
  </div>

</div>

<!-- Símil Cotidiano -->
<div v-click="3" class="mt-2 py-2.5 px-3 rounded-xl bg-slate-800 text-white text-xs flex items-center justify-between shadow-md">
  <div class="flex items-center gap-2.5">
    <div class="leading-snug">
      <b class="text-amber-400 text-[11px] block mb-0.5">Símil Cotidiano: Receta de Cocina</b>
      <p class="opacity-80 text-[10px] m-0 p-0 leading-tight">
        <b>Ingredientes</b> (Entrada) ➔ <b>Preparación</b> (Proceso) ➔ <b>Plato Final</b> (Salida)
      </p>
    </div>
  </div>
  <span class="text-[11px] font-mono bg-slate-700/80 text-slate-300 px-2.5 py-1 rounded border border-slate-600/80 whitespace-nowrap hidden sm:block">
...
<div v-click="1" class="my-3 p-3.5 rounded-xl bg-indigo-500/10 border-l-4 border-indigo-500 text-xs leading-relaxed">
  <b class="text-indigo-600 dark:text-indigo-400">Medio sistemático de organización:</b> Permite almacenar y estructurar datos en la memoria de la computadora para facilitar su acceso, manipulación y modificación eficiente.
</div>
...
<div v-click="2" class="my-2 p-3 rounded-xl bg-slate-900 text-white shadow-md border border-slate-700/80 text-center">
  <div class="inline-block px-2.5 py-0.5 rounded-full bg-indigo-500/20 text-indigo-300 text-[10px] font-mono font-bold mb-2 uppercase tracking-wider">
    Niklaus Wirth — Creador de Pascal
  </div>
  
  <div class="flex items-center justify-center gap-2 sm:gap-3 my-1">
    <div class="px-3 py-1.5 rounded-lg bg-blue-500/20 border border-blue-400/30 text-blue-300 font-bold text-xs">
      Algoritmos
    </div>
    <span class="text-amber-400 font-bold text-sm">+</span>
    <div class="px-3 py-1.5 rounded-lg bg-purple-500/20 border border-purple-400/30 text-purple-300 font-bold text-xs">
      Estructuras de Datos
    </div>
    <span class="text-amber-400 font-bold text-sm">=</span>
    <div class="px-4 py-1.5 rounded-lg bg-emerald-500/30 border border-emerald-400/40 text-emerald-300 font-extrabold text-xs shadow-xs">
      Programas
    </div>
  </div>
</div>
  ...
  <table class="w-full text-[10.5px] text-left border-collapse">
    <thead>
      <tr class="bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        ...
        <th class="py-2 px-3 font-bold text-blue-600 dark:text-blue-400 w-3/8">⚙️ Algoritmo</th>
